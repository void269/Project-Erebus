...
class App_Logger
  ...
  def write(log_level = "INFO", text = nil, app_name = "Erebus", log = @logfile)
    ...
    log_level = "OTHER" unless log_level.upcase == "INFO" || log_level.upcase == "WARN" || log_level.upcase == "ERROR" || log_level.upcase == :INFO || log_level.upcase == :WARN || log_level.upcase == :ERROR
